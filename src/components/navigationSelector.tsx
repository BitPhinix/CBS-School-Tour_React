                ...
                <div className="blueContainer">
                    ...
                    <div className="modeContainer">
                        ...
                        <div className="iconContainer">
                            <div className="circleContainer selected">
                                <svg className="walk" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" enable-background="new 0 0 512 512">
                        ...
                        <div className="iconContainer">
                            <div className="circleContainer selected">
                                <svg className="clock" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                    <path fill="rgba(255, 255, 255, 0.85)" stroke="#231F20" stroke-width="3.3461" stroke-miterlimit="10" d="M64.014,74.898"/>
                    ...
                    <div className="routingContainer">
                        <div className="leftContainer">
                            ...
                            <div className="beginningContainer hover">
                            ...
                            <div className="destinationContainer hover">
